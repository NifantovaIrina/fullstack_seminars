...
class BattleSerializer(serializers.ModelSerializer):
    ...
    participants = PrimaryKeyRelatedField(many=True, queryset=User.objects.all(), read_only=False)
    ...
    def create(self, validated_data):
        battle = Battle(name=validated_data['name'], tournament=validated_data['tournament'])
        battle.save()
